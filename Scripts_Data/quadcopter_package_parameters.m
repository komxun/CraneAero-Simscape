...
% ki_position    = 0.01;    % keep very small
...
filtM_altitude = 0.05;
kp_altitude    = 5.0;    % ~17x original 0.27 (mass ratio)
ki_altitude    = 1.0;    % ~17x original 0.07, conservative
kd_altitude    = 6.0;    % ~17x original 0.35
filtD_altitude = 100;
